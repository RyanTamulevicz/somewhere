const D = globalThis, F = D.ShadowRoot && (D.ShadyCSS === void 0 || D.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, q = /* @__PURE__ */ Symbol(), X = /* @__PURE__ */ new WeakMap();
let le = class {
  constructor(e, t, n) {
  ...
  get styleSheet() {
    ...
    if (F && e === void 0) {
      ...
      n && (e = X.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), n && X.set(t, e));
    }
    return e;
  }
  toString() {
...
const ge = (a) => new le(typeof a == "string" ? a : a + "", void 0, q), pe = (a, ...e) => {
  const t = a.length === 1 ? a[0] : e.reduce((n, i, s) => n + ((r) => {
  ...
  if (F) a.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
  else for (const t of e) {
    const n = document.createElement("style"), i = D.litNonce;
    i !== void 0 && n.setAttribute("nonce", i), n.textContent = t.cssText, a.appendChild(n);
  }
}, Q = F ? (a) => a : (a) => a instanceof CSSStyleSheet ? ((e) => {
  let t = "";
  for (const n of e.cssRules) t += n.cssText;
  return ge(t);
})(a) : a;
const { is: ye, defineProperty: be, getOwnPropertyDescriptor: fe, getOwnPropertyNames: _e, getOwnPropertySymbols: Oe, getPrototypeOf: ze } = Object, U = globalThis, ee = U.trustedTypes, Pe = ee ? ee.emptyScript : "", ve = U.reactiveElementPolyfillSupport, w = (a, e) => a, x = { toAttribute(a, e) {
  switch (e) {
    case Boolean:
      a = a ? Pe : null;
      break;
  ...
  return t;
} }, Y = (a, e) => !ye(a, e), ae = { attribute: !0, type: String, converter: x, reflect: !1, useDefault: !1, hasChanged: Y };
...
let v = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, n) {
    const { get: i, set: s } = fe(this.prototype, e) ?? { get() {
      return this[t];
    }, set(r) {
      this[t] = r;
    } };
    return { get: i, set(r) {
      const u = i?.call(this);
      s?.call(this, r), this.requestUpdate(e, u, n);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(w("properties"))) {
      const t = this.properties, n = [..._e(t), ...Oe(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const i of n) t.unshift(Q(i));
  ...
  _$ET(e, t) {
    ...
    if (i !== void 0 && n.reflect === !0) {
      const s = (n.converter?.toAttribute !== void 0 ? n.converter : x).toAttribute(t, n.type);
  ...
  _$AK(e, t) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const s = n.getPropertyOptions(i), r = typeof s.converter == "function" ? { fromAttribute: s.converter } : s.converter?.fromAttribute !== void 0 ? s.converter : x;
      this._$Em = i;
      const u = r.fromAttribute(t, s.type);
  ...
  requestUpdate(e, t, n, i = !1, s) {
    if (e !== void 0) {
      ...
      if (i === !1 && (s = this[e]), n ??= r.getPropertyOptions(e), !((n.hasChanged ?? Y)(s, t) || n.useDefault && n.reflect && s === this._$Ej?.get(e) && !this.hasAttribute(r._$Eu(e, n)))) return;
      this.C(e, t, n);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$EP());
  }
  C(e, t, { useDefault: n, reflect: i, wrapped: s }, r) {
    n && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(e) && (this._$Ej.set(e, r ?? t ?? this[e]), s !== !0 || r !== void 0) || (this._$AL.has(e) || (this.hasUpdated || n || (t = void 0), this._$AL.set(e, t)), i === !0 && this._$Em !== e && (this._$Eq ??= /* @__PURE__ */ new Set()).add(e));
  }
  async _$EP() {
...
v.elementStyles = [], v.shadowRootOptions = { mode: "open" }, v[w("elementProperties")] = /* @__PURE__ */ new Map(), v[w("finalized")] = /* @__PURE__ */ new Map(), ve?.({ ReactiveElement: v }), (U.reactiveElementVersions ??= []).push("2.1.2");
const W = globalThis, te = (a) => a, G = W.trustedTypes, ne = G ? G.createPolicy("lit-html", { createHTML: (a) => a }) : void 0, Ae = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, he = "?" + y, Te = `<${he}>`, O = document, L = () => O.createComment(""), Z = (a) => a === null || typeof a != "object" && typeof a != "function", J = Array.isArray, Ee = (a) => J(a) || typeof a?.[Symbol.iterator] == "function", K = `[ 	
\f\r]`, I = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ie = /-->/g, se = />/g, f = RegExp(`>|${K}(?:([^\\s"'>=/]+)(${K}*=${K}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), re = /'/g, oe = /"/g, ce = /^(?:script|style|textarea|title)$/i, Me = (a) => (e, ...t) => ({ _$litType$: a, strings: e, values: t }), c = Me(1), E = /* @__PURE__ */ Symbol.for("lit-noChange"), h = /* @__PURE__ */ Symbol.for("lit-nothing"), ue = /* @__PURE__ */ new WeakMap(), _ = O.createTreeWalker(O, 129);
function me(a, e) {
...
const Re = (a, e) => {
  ...
  let i, s = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", r = I;
  for (let u = 0; u < t; u++) {
    const o = a[u];
    let d, A, l = -1, S = 0;
    for (; S < o.length && (r.lastIndex = S, A = r.exec(o), A !== null); ) S = r.lastIndex, r === I ? A[1] === "!--" ? r = ie : A[1] !== void 0 ? r = se : A[2] !== void 0 ? (ce.test(A[2]) && (i = RegExp("</" + A[2], "g")), r = f) : A[3] !== void 0 && (r = f) : r === f ? A[0] === ">" ? (r = i ?? I, l = -1) : A[1] === void 0 ? l = -2 : (l = r.lastIndex - A[2].length, d = A[1], r = A[3] === void 0 ? f : A[3] === '"' ? oe : re) : r === oe || r === re ? r = f : r === ie || r === se ? r = I : (r = f, i = void 0);
    const m = r === f && a[u + 1].startsWith("/>") ? " " : "";
    s += r === I ? o + Te : l >= 0 ? (n.push(d), o.slice(0, l) + Ae + o.slice(l) + y + m) : o + y + (l === -2 ? u : m);
  }
  return [me(a, s + (a[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), n];
};
class B {
  constructor({ strings: e, _$litType$: t }, n) {
    ...
    this.parts = [];
    let s = 0, r = 0;
    const u = e.length - 1, o = this.parts, [d, A] = Re(e, t);
    if (this.el = B.createElement(d, n), _.currentNode = this.el.content, t === 2 || t === 3) {
      const l = this.el.content.firstChild;
      l.replaceWith(...l.childNodes);
    }
    for (; (i = _.nextNode()) !== null && o.length < u; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(Ae)) {
          const S = A[r++], m = i.getAttribute(l).split(y), z = /([.?@])?(.*)/.exec(S);
          o.push({ type: 1, index: s, name: z[2], strings: m, ctor: z[1] === "." ? we : z[1] === "?" ? Le : z[1] === "@" ? Ze : H }), i.removeAttribute(l);
        } else l.startsWith(y) && (o.push({ type: 6, index: s }), i.removeAttribute(l));
        if (ce.test(i.tagName)) {
          const l = i.textContent.split(y), S = l.length - 1;
          if (S > 0) {
            i.textContent = G ? G.emptyScript : "";
            for (let m = 0; m < S; m++) i.append(l[m], L()), _.nextNode(), o.push({ type: 2, index: ++s });
            i.append(l[S], L());
          }
        }
      } else if (i.nodeType === 8) if (i.data === he) o.push({ type: 2, index: s });
      else {
        let l = -1;
        for (; (l = i.data.indexOf(y, l + 1)) !== -1; ) o.push({ type: 7, index: s }), l += y.length - 1;
      }
      s++;
    }
  }
...
function M(a, e, t = a, n) {
  if (e === E) return e;
  let i = n !== void 0 ? t._$Co?.[n] : t._$Cl;
  const s = Z(e) ? void 0 : e._$litDirective$;
  return i?.constructor !== s && (i?._$AO?.(!1), s === void 0 ? i = void 0 : (i = new s(a), i._$AT(a, t, n)), n !== void 0 ? (t._$Co ??= [])[n] = i : t._$Cl = i), i !== void 0 && (e = M(a, i._$AS(a, e.values), i, n)), e;
}
class Ie {
  constructor(e, t) {
  ...
  u(e) {
    const { el: { content: t }, parts: n } = this._$AD, i = (e?.creationScope ?? O).importNode(t, !0);
    _.currentNode = i;
    let s = _.nextNode(), r = 0, u = 0, o = n[0];
    for (; o !== void 0; ) {
      if (r === o.index) {
        let d;
        o.type === 2 ? d = new k(s, s.nextSibling, this, e) : o.type === 1 ? d = new o.ctor(s, o.name, o.strings, this, e) : o.type === 6 && (d = new Be(s, this, e)), this._$AV.push(d), o = n[++u];
      }
      r !== o?.index && (s = _.nextNode(), r++);
    }
    return _.currentNode = O, i;
  }
  p(e) {
    let t = 0;
...
class k {
  ...
  constructor(e, t, n, i) {
    this.type = 2, this._$AH = h, this._$AN = void 0, this._$AA = e, this._$AB = t, this._$AM = n, this.options = i, this._$Cv = i?.isConnected ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, t = this) {
    e = M(this, e, t), Z(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== E && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ee(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== h && Z(this._$AH) ? this._$AA.nextSibling.data = e : this.T(O.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    const { values: t, _$litType$: n } = e, i = typeof n == "number" ? this._$AC(e) : (n.el === void 0 && (n.el = B.createElement(me(n.h, n.h[0]), this.options)), n);
    if (this._$AH?._$AD === i) this._$AH.p(t);
    else {
      const s = new Ie(i, this), r = s.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let n, i = 0;
    for (const s of e) i === t.length ? t.push(n = new k(this.O(L()), this.O(L()), this, this.options)) : n = t[i], n._$AI(s), i++;
...
class H {
  ...
  constructor(e, t, n, i, s) {
    this.type = 1, this._$AH = h, this._$AN = void 0, this.element = e, this.name = t, this._$AM = i, this.options = s, n.length > 2 || n[0] !== "" || n[1] !== "" ? (this._$AH = Array(n.length - 1).fill(new String()), this.strings = n) : this._$AH = h;
  }
  _$AI(e, t = this, n, i) {
    const s = this.strings;
    let r = !1;
    if (s === void 0) e = M(this, e, t, 0), r = !Z(e) || e !== this._$AH && e !== E, r && (this._$AH = e);
    else {
      const u = e;
      let o, d;
      for (e = s[0], o = 0; o < s.length - 1; o++) d = M(this, u[n + o], t, o), d === E && (d = this._$AH[o]), r ||= !Z(d) || d !== this._$AH[o], d === h ? e = h : e !== h && (e += (d ?? "") + s[o + 1]), this._$AH[o] = d;
    }
    r && !i && this.j(e);
  }
  j(e) {
...
ke?.(B, k), (W.litHtmlVersions ??= []).push("3.3.2");
const De = (a, e, t) => {
  const n = t?.renderBefore ?? e;
  let i = n._$litPart$;
  if (i === void 0) {
    const s = t?.renderBefore ?? null;
    n._$litPart$ = i = new k(e.insertBefore(L(), s), s, void 0, t ?? {});
  }
  return i._$AI(a), i;
};
const j = globalThis;
...
const Ge = { attribute: !0, type: String, converter: x, reflect: !1, hasChanged: Y }, Ue = (a = Ge, e, t) => {
  const { kind: n, metadata: i } = t;
  let s = globalThis.litPropertyMetadata.get(i);
  if (s === void 0 && globalThis.litPropertyMetadata.set(i, s = /* @__PURE__ */ new Map()), n === "setter" && ((a = Object.create(a)).wrapped = !0), s.set(t.name, a), n === "accessor") {
    const { name: r } = t;
    return { set(u) {
      const o = e.get.call(this);
      e.set.call(this, u), this.requestUpdate(r, o, a, !0, u);
    }, init(u) {
      return u !== void 0 && this.C(r, void 0, a, u), u;
    } };
  }
  if (n === "setter") {
    const { name: r } = t;
    return function(u) {
      const o = this[r];
      e.call(this, u), this.requestUpdate(r, o, a, !0, u);
    };
  }
  throw Error("Unsupported decorator location: " + n);
};
function C(a) {
  return (e, t) => typeof t == "object" ? Ue(a, e, t) : ((n, i, s) => {
...
const $ = (a) => a ?? h;
var He = Object.defineProperty, Ke = Object.getOwnPropertyDescriptor, g = (a, e, t, n) => {
  for (var i = n > 1 ? void 0 : n ? Ke(e, t) : e, s = a.length - 1, r; s >= 0; s--)
    (r = a[s]) && (i = (n ? r(e, t, i) : r(i)) || i);
  return n && i && He(e, t, i), i;
};
let p = class extends T {
  constructor() {
    super(...arguments), this.options = [], this.value = "", this.placeholder = "Select an option", this.required = !1, this.disabled = !1, this.error = !1, this.searchThreshold = 8, this._open = !1, this._query = "", this._panelDirection = "down", this._panelMaxHeight = 256, this._handleDocumentPointerDown = (a) => {
      a.composedPath().includes(this) || this._closePanel();
    }, this._handleViewportChange = () => {
      this._open && this._updatePanelPlacement();
    };
  }
  connectedCallback() {
    super.connectedCallback(), document.addEventListener("pointerdown", this._handleDocumentPointerDown), window.addEventListener("resize", this._handleViewportChange), document.addEventListener("scroll", this._handleViewportChange, !0);
  }
  disconnectedCallback() {
    document.removeEventListener("pointerdown", this._handleDocumentPointerDown), window.removeEventListener("resize", this._handleViewportChange), document.removeEventListener("scroll", this._handleViewportChange, !0), super.disconnectedCallback();
  }
  get _selectedOption() {
    return this.options.find((a) => a.value === this.value);
  }
  get _showSearch() {
    return this.options.length >= this.searchThreshold;
  }
  get _filteredOptions() {
    const a = this._query.trim().toLowerCase();
    return a ? this.options.filter((e) => e.label.toLowerCase().includes(a) || e.value.toLowerCase().includes(a)) : this.options;
  }
  get _groupedOptions() {
    const a = /* @__PURE__ */ new Map();
    for (const e of this._filteredOptions) {
      const t = e.group || "", n = a.get(t) || [];
      n.push(e), a.set(t, n);
    }
    return [...a.entries()];
  }
  ...
  _openPanel() {
    this.disabled || this._open || (this._open = !0, this.updateComplete.then(() => {
      ...
      const a = this.shadowRoot?.querySelector(".search");
      a?.focus(), a?.select();
    }));
  }
  _closePanel() {
  ...
  _handleTriggerKeyDown(a) {
    (a.key === "ArrowDown" || a.key === "Enter" || a.key === " ") && (a.preventDefault(), this._openPanel());
  }
  _handlePanelKeyDown(a) {
    a.key === "Escape" && (a.preventDefault(), this._closePanel(), this.shadowRoot?.querySelector(".trigger")?.focus());
  }
  _handleQueryInput(a) {
    this._query = a.target.value;
  }
  _selectOption(a) {
    a.value !== this.value && (this.value = a.value, this.dispatchEvent(new CustomEvent("change", {
      ...
      ${this._open ? c`
        ...
        >
          ...
          <div class="options" role="listbox" aria-required="${this.required ? "true" : "false"}">
            ${this._filteredOptions.length === 0 ? c`<div class="empty">No matches found.</div>` : this._groupedOptions.map(([a, e]) => c`
                  <div class="group">
                    ${a ? c`<div class="group-label">${a}</div>` : null}
                    ${e.map((t) => c`
                      <button
                        type="button"
                        class="option ${t.value === this.value ? "selected" : ""}"
                        role="option"
                        aria-selected="${t.value === this.value ? "true" : "false"}"
...
g([
  C({ type: Number, attribute: "search-threshold" })
], p.prototype, "searchThreshold", 2);
g([
  R()
], p.prototype, "_open", 2);
g([
...
g([
  R()
], p.prototype, "_panelDirection", 2);
g([
  R()
], p.prototype, "_panelMaxHeight", 2);
p = g([
  Ce("searchable-select")
], p);
function $e(a) {
  const e = [], t = /%([NOACSZXD])/g;
  let n;
  for (; (n = t.exec(a)) !== null; ) {
    const i = n[1];
...
function qe(a) {
  const e = a.state_name_type?.toLowerCase() || "province";
  return {
    state: "State",
    province: "Province",
    county: "County",
...
function Ye(a) {
  const e = a.sublocality_name_type?.toLowerCase(), t = a.id?.replace("data/", ""), n = {
    IR: "District"
...
function We(a) {
  const e = a.zip_name_type?.toLowerCase();
  if (e === "pin") return "PIN Code";
  if (e === "postal") return "Postal Code";
  if (e === "zip") return "ZIP Code";
  if (e === "eircode") return "Eircode";
  const t = a.id?.toUpperCase();
  return t === "US" ? "ZIP Code" : t === "IE" ? "Eircode" : t === "IN" ? "PIN Code" : "Postal Code";
}
function Je(a) {
  return a.zipex ? a.zipex.split(",").map((e) => e.trim()).filter(Boolean) : [];
}
function je(a) {
  if (a.length !== 0)
    return a.every((e) => /^[\d\s-]+$/.test(e)) ? "numeric" : void 0;
}
function Xe(a) {
  if (a.length !== 0)
...
function ea(a, e) {
  return e.countryCode === "US" ? /^\d{5}(?:[ -]\d{4})?$/.test(a) : ia(a, e.pattern);
}
function Se(a, e) {
  const t = [];
  return a.required && (!e || typeof e == "string" && e.trim() === "") ? (t.push(`${a.label} is required`), t) : (typeof e != "string" || e.length === 0 || a.key === "postalCode" && !ea(e, a) && t.push(`Invalid ${a.label.toLowerCase()} format`), t);
}
function aa(a) {
  if (!a.sub_keys || !a.sub_names)
    return;
  const e = a.sub_keys.split("~"), t = a.sub_lnames, n = t?.split("~") || a.sub_names.split("~");
  return e.map((i, s) => ({
...
function ta(a, e = {}) {
  const t = [], n = (a.require || "").split(""), i = a.fmt || "%N%n%O%n%A%n%C %Z", s = $e(i), r = [], u = a.id?.replace("data/", ""), o = ["JP", "CN", "TW", "KR", "VN", "ID", "TH", "PH", "MY", "SG"].includes(u || "");
  for (const d of s) {
    if (d === "A") {
      const z = o ? ["addressLine1", "addressLine2", "addressLine3"] : ["addressLine1", "addressLine2"];
      for (const P of z)
        r.includes(P) || (t.push({
          key: P,
          label: P === "addressLine1" ? "Street Address" : "Apartment, suite, etc.",
          required: P === "addressLine1" && n.includes("A"),
          visible: !0,
          type: "text",
          width: "full",
          placeholder: P === "addressLine1" ? "123 Main St" : "Apt 4B"
        }), r.push(P));
      continue;
    }
    if (d === "N" && !e.showName || d === "O" && !e.showOrganization) continue;
    const A = na(d);
    if (!A) continue;
    const l = n.includes(d), S = d === "S" ? aa(a) : void 0, m = d === "Z" ? Je(a) : void 0;
    t.push({
      key: A,
      label: Fe(d, a, e.showName),
      required: l,
      visible: !0,
      countryCode: u,
      type: S ? "select" : "text",
      options: S,
      pattern: d === "Z" ? a.zip : void 0,
      placeholder: d === "Z" ? m?.[0] : void 0,
      examples: m,
      inputMode: d === "Z" ? je(m || []) : void 0,
      minLength: d === "Z" ? Qe(u) : void 0,
      maxLength: d === "Z" ? Xe(m || []) : void 0,
      width: Ve(d)
    });
  }
  return t;
...
function ia(a, e) {
  if (!e) return !0;
  if (!a) return !1;
  const t = e.replace(/\\d/g, "\\d").replace(/\\s/g, "\\s");
  try {
    return new RegExp(`^${t}$`, "i").test(a);
  } catch {
    return a.length > 0;
  }
}
function sa(a, e) {
  ...
  for (const i of e) {
    ...
    const s = Se(i, a[i.key]);
    s.length > 0 && (n[i.key] = s, t.push(...s));
  }
  return {
    valid: t.length === 0,
    errors: t,
...
var oa = Object.defineProperty, ua = Object.getOwnPropertyDescriptor, b = (a, e, t, n) => {
  for (var i = n > 1 ? void 0 : n ? ua(e, t) : e, s = a.length - 1, r; s >= 0; s--)
    (r = a[s]) && (i = (n ? r(e, t, i) : r(i)) || i);
...
let N = class extends T {
  ...
  willUpdate(a) {
    a.has("country") && (this._updateFieldConfigs(), this._resetInapplicableFields());
  }
  _updateFieldConfigs() {
    const a = de(this.country);
    this._fieldConfigs = ta(a, {
      showName: this.showName,
      showOrganization: this.showOrganization
    });
  }
  _resetInapplicableFields() {
    const a = new Set(this._fieldConfigs.map((t) => t.key)), e = { country: this.country };
    for (const [t, n] of Object.entries(this.value))
      (t === "country" || a.has(t)) && (e[t] = n);
    this.value = e;
  }
  _handleCountryChange(a) {
    const e = a.detail.value;
    this.country = e, this._emitChange();
  }
  _handleFieldChange(a, e) {
    const t = e.target;
    this.value = { ...this.value, [a]: t.value }, this._touchedFields.add(a), this._validateField(a), this._emitChange();
  }
  _handleFieldSelectChange(a, e) {
    this.value = { ...this.value, [a]: e }, this._touchedFields.add(a), this._validateField(a), this._emitChange();
  }
  _handleFieldBlur(a) {
    this._touchedFields = /* @__PURE__ */ new Set([...this._touchedFields, a]), this._validateField(a);
  }
  _validateField(a) {
    const e = this._fieldConfigs.find((n) => n.key === a);
    if (!e) return;
    const t = Se(e, this.value[a]);
    t.length > 0 ? this._fieldErrors[a] = t[0] : delete this._fieldErrors[a], this.requestUpdate();
  }
  _markVisibleFieldsTouched() {
    this._touchedFields = /* @__PURE__ */ new Set([
      ...this._touchedFields,
      ...this._fieldConfigs.filter((a) => a.visible).map((a) => a.key)
    ]);
  }
  _applyValidation(a) {
    return this._fieldErrors = Object.fromEntries(
      Object.entries(a.fieldErrors).map(([e, t]) => [e, t?.[0]]).filter((e) => typeof e[1] == "string")
    ), this.requestUpdate(), a;
  }
  _validateAll(a = {}) {
    a.markVisibleFieldsTouched && this._markVisibleFieldsTouched();
    const e = sa(this.value, this._fieldConfigs);
    return this._applyValidation(e);
  }
  _emitValidation(a) {
    this.dispatchEvent(new CustomEvent("valid", {
      detail: { valid: a.valid, errors: a.errors },
      bubbles: !0,
      composed: !0
    }));
  }
  _emitChange() {
    ...
    const e = this._validateAll();
    this._emitValidation(e);
  }
  _getCountryOption(a) {
    const e = de(a);
    return { value: a, label: e.name || a, group: "" };
  }
  _getCountryOptions() {
    const a = {
      "Frequently Used": [],
      "A-M": [],
      "N-Z": []
    }, e = ["US", "CA", "GB", "AU", "DE", "FR", "JP", "CN", "IN", "BR", "MX"];
    for (const t of ra) {
      if (t === "ZZ") continue;
      const n = this._getCountryOption(t);
      let i = "N-Z";
      e.includes(t) ? i = "Frequently Used" : n.label.charAt(0).toUpperCase() <= "M" && (i = "A-M"), a[i].push({ ...n, group: i });
    }
    return Object.values(a).flatMap((t) => t.sort((n, i) => n.label.localeCompare(i.label)));
  }
  _renderSelectOptions(a, e, t) {
    const n = a.options || [];
    return c`
      <searchable-select
        .options="${n}"
      ...
      this._handleFieldSelectChange(a.key, s);
    }}"
      ></searchable-select>
    `;
  }
  _renderCountrySelect() {
    const a = this._getCountryOptions();
    return c`
  ...
  _renderField(a) {
    ...
    const e = this.value[a.key] || "", t = this._fieldErrors[a.key], n = this._touchedFields.has(a.key), i = !!(t && (n || this._touchedFields.size > 0)), s = {
    ...
    return c`
      <div class="field ${s}">
        <label class="${a.required ? "required" : ""}">${a.label}</label>
        ${a.type === "select" && a.options ? this._renderSelectOptions(a, e, i) : c`
              <input
                type="text"
                class="${i ? "error" : ""}"
                .value="${e}"
                .placeholder="${a.placeholder || ""}"
                @input="${(r) => this._handleFieldChange(a.key, r)}"
                @blur="${() => this._handleFieldBlur(a.key)}"
                ?required="${a.required}"
                pattern="${a.pattern || ""}"
                inputmode="${$(a.inputMode)}"
                minlength="${$(a.minLength?.toString())}"
                maxlength="${$(a.maxLength?.toString())}"
              />
            `}
        ${i ? c`<span class="error-message">${t}</span>` : null}
      </div>
    `;
  }
  _renderFieldsByRow() {
    ...
    for (const n of this._fieldConfigs) {
      ...
      t + i > 100 && e.length > 0 && (a.push([...e]), e = [], t = 0), e.push(n), t += i, i === 100 && (a.push([...e]), e = [], t = 0);
    }
    return e.length > 0 && a.push(e), a.map((n) => c`
      <div class="field-row">
   ...
   */
  validate() {
    const a = this._validateAll({ markVisibleFieldsTouched: !0 });
    return this._emitValidation(a), a.valid;
  }
  /**
   ...
   */
  setValue(a) {
    a.country && a.country !== this.country && (this.country = a.country), this.value = { ...this.value, ...a }, this.requestUpdate();
  }
};
N.styles = pe`
    :host {
...
b([
  C({ type: Boolean, attribute: "show-organization" })
], N.prototype, "showOrganization", 2);
b([
  C({ type: Boolean, attribute: "show-name" })
], N.prototype, "showName", 2);
b([
  R()
], N.prototype, "_fieldErrors", 2);
b([
  R()
], N.prototype, "_touchedFields", 2);
N = b([
  Ce("address-input")
], N);
export {
